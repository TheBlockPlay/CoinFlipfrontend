...
const StartPhase = () => {
    ...
    return (
        <>
            ...
            <Link href={'/approve'}>
                <button className="flex justify-center mt-[30px] gap-3 items-center bg-[#F4C542] border border-[#F4C542] hover:text-[#F4C542] hover:bg-transparent p-[14px] w-full rounded-[8px] text-white font-semibold text-[16px] leading-[100%] tracking-[0%] text-center transition duration-300">
                    Start Game
